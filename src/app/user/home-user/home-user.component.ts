...
export class HomeUserComponent implements OnInit {
  ...
  getOffers() {
    ...
    this.http.get('http://backend-tic-enit.herokuapp.com/offers' , { headers: reqHeader }).subscribe((data: any) => {
      console.log(data);
      this.offers1 = data;
  ...
  getCompaniesInfo() {
    ...
    const reqHeader = new HttpHeaders({ 'Authorization': 'Bearer ' + localStorage.getItem('userToken')});
    this.http.post('http://backend-tic-enit.herokuapp.com/student/companiesinfo' , { companies : this.companiesId}, { headers: reqHeader }).subscribe((data: any) => {
  ...
  postCandidacy(cand: Candidacy) {
    console.log(cand);
    const reqHeader = new HttpHeaders({ 'Authorization': 'Bearer ' + localStorage.getItem('userToken')});
    this.http.post('http://backend-tic-enit.herokuapp.com/student/apply/' + this.idOffer, cand , { headers: reqHeader }).subscribe((data: any) => {
     // console.log(data);
