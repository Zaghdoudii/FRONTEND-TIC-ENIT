...
export class HomeCompanyComponent implements OnInit {
  ...
  postOffer(offer : Offer){
    ...
    this.http.post("http://backend-tic-enit.herokuapp.com/offers",offer ,{ headers: reqHeader }).subscribe((data : any)=>{
     console.log(data);
    this.offerTitle = "";
    this.content = "";
  ...
  getOffers(){
    console.log("http://backend-tic-enit.herokuapp.com/offers/myoffers?id="+localStorage.getItem('company_id'));
    var reqHeader = new HttpHeaders({ 'Authorization': 'Bearer ' + localStorage.getItem("companyToken")});
    this.http.get("http://backend-tic-enit.herokuapp.com/offers/myoffers?id="+localStorage.getItem('company_id') ,{ headers: reqHeader }).subscribe((data : any) => {
      this.offers = data;
  ...
  deleteOffer(id : string){
    var reqHeader = new HttpHeaders({ 'Authorization': 'Bearer ' + localStorage.getItem("companyToken")});
    this.http.delete("http://backend-tic-enit.herokuapp.com/offers?id="+id,{ headers: reqHeader }).subscribe((data : any) => {
      console.log(data);
      this.getOffers();
    },
    (err : HttpErrorResponse)=>{
  ...
  updateOffer(){
    ...
    console.log(offer);
    var reqHeader = new HttpHeaders({ 'Authorization': 'Bearer ' + localStorage.getItem("companyToken")});
    this.http.patch("http://backend-tic-enit.herokuapp.com/offers?id="+this.idUpdate,offer,{ headers: reqHeader }).subscribe((data : any) => {
      console.log(data);
      this.togglePopup();
      this.getOffers();
    },
